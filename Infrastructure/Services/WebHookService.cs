...
public class WebHookService : IWebHookService
{
    ...
    public WebHookService(ILsn50V2d20Logic lsn50V2d20Logic, ILogger<WebHookService> logger, ISensorRepository sensorRepository)
    {
    ...
    public async Task<bool> AkenzaCallProcessAsync(JObject jObject)
    {
        ...
        if (sensor == null)
        {
            _logger.LogError($"No Sensor found with devEui: {devEui}");
        }
        switch (topic)
        {
            case "lifecycle":

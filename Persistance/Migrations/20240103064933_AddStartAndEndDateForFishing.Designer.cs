...
namespace Persistence.Migrations
{
    ...
    [Migration("20240103064933_AddStartAndEndDateForFishing")]
    partial class AddStartAndEndDateForFishing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6b4e2e68-b07b-4242-b8f1-80e37c86d60d",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAE/pyDdAOwaUw4nAr0vTgig38fcRgA9TDuhZTOlSopezrvBohH4zHfLT92BDQLS/g==",
            ...
            modelBuilder.Entity("Domain.Entities.CatchDetail", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.FishType", "FishType")
                        .WithOne("CatchDetail")
                        .HasForeignKey("Domain.Entities.CatchDetail", "FishTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

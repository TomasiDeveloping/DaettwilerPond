...
} from './pages/admin/admin-fishing-regulation/admin-fishing-regulation.component';
...
} from './pages/admin/admin-fish-types/admin-edit-fish-type/admin-edit-fish-type.component';
import {
  AdminEditFishingRegulationComponent
} from './pages/admin/admin-fishing-regulation/admin-edit-fishing-regulation/admin-edit-fishing-regulation.component';
import {
  AdminEditFishingLicenseComponent
} from './pages/admin/admin-fishing-license/admin-edit-fishing-license/admin-edit-fishing-license.component';
